package dev.roland.inventory_management_backend.features.stock_balance;
...
/**
 * Stores the current aggregate quantity of one product in one warehouse.
 *
 * <p>This is a read-optimized projection, not the inventory audit source of truth. The unique
 * warehouse-product pair is updated from {@link StockMovement} records generated by document
 * posting. It references one {@link Warehouse} and one {@link Product}.
 */
@Entity
@Table(
    name = "stock_balances",
